...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        imageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"videoProjector"]];
        imageView.frame = CGRectMake(0,30,self.frame.size.width,150);
#warning placeholder stuff, replace with card-specific information {
        ...
        [information setText:@"Video Projector"];
